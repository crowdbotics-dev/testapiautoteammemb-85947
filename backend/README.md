...
## Project Structure
    ...
    ├── testapiautoteammemb_85947  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_85947`
...
2. Clone this repo and `cd testapiautoteammemb_85947`
